...
# Function to perform anti-spoofing check based on texture analysis
def anti_spoofing_check(face_image):
    # Calculate Laplacian variance as a measure of texture
    laplacian_var = cv2.Laplacian(face_image, cv2.CV_64F).var()

    # Set a threshold for distinguishing between real and spoofed faces
    threshold = 100  # Adjust this threshold as needed

    # If Laplacian variance is below the threshold, consider it spoofed
