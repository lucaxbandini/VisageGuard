...
class BlinkDetectionApp:
    def __init__(self, root):
        ...
        self.max_face_detection_duration = 5  # Default maximum face detection duration in seconds
        self.max_no_blink_duration = 10  # Default maximum no blink duration in seconds
        ...
        # Auto-start checkbox
        self.autostart_checkbox = ttk.Checkbutton(self.button_frame, text="Start on Startup", variable=self.autostart_var)
        self.autostart_checkbox.pack(pady=5, anchor=tk.W)

        # Toggle detection checkbox
        self.detection_checkbox = ttk.Checkbutton(self.button_frame, text="Facial Recognition", variable=self.detection_var, command=self.toggle_detection)
        self.detection_checkbox.pack(pady=5, anchor=tk.W)

        # Settings button
        self.settings_button = ttk.Button(self.button_frame, text="Settings", command=self.show_settings)
        ...
        # Stop button
        self.stop_button = ttk.Button(self.button_frame, text="Stop", command=self.stop_detection, state=tk.DISABLED)
    ...
    def show_settings(self):
        ...
        max_face_detection_duration_label = ttk.Label(settings_window, text="Max Face Detection Duration (s):")
        max_face_detection_duration_label.pack(pady=5)
        max_face_detection_duration_entry = ttk.Entry(settings_window)
        ...
        max_no_blink_duration_label = ttk.Label(settings_window, text="Max No Blink Duration (s):")
        max_no_blink_duration_label.pack(pady=5)
        max_no_blink_duration_entry = ttk.Entry(settings_window)
    ...
    # Function to detect blinks and facial features
    ...
    # Function to lock the PC and provide reason for locking
    def lock_pc(self):
